...
from dock2hit.model import generate_batch, validate, multi_featurize, collate, pmap
...
def main(args, device):
    ...
    X_train = multi_featurize(
        X_train, atom_featurizer, bond_featurizer, n_jobs=4)
