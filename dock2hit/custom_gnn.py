...
class LeakyMPNNGNN(nn.Module):
    """Custom GNN with LeakyRELU instead.
    ...
    def __init__(self, node_in_feats, edge_in_feats, node_out_feats=64,
        ...
        super(LeakyMPNNGNN, self).__init__()
    ...
    def forward(self, g, node_feats, edge_feats):
        ...
        hidden_feats = node_feats.unsqueeze(
            0)           # (1, V, node_out_feats)
...
class LeakyMPNNPredictor(nn.Module):
    """MPNN for regression and classification on graphs with LeakyRELU functions.
    ...
    def __init__(self,
                 ...
                 num_step_set2set=6,
                 num_layer_set2set=3):
        super(LeakyMPNNPredictor, self).__init__()

        self.gnn = LeakyMPNNGNN(node_in_feats=node_in_feats,
